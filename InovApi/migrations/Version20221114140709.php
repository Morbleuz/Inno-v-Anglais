 ...
 */
final class Version20221114140709 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE test_user (test_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_88EAFC861E5D0459 (test_id), INDEX IDX_88EAFC86A76ED395 (user_id), PRIMARY KEY(test_id, user_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
